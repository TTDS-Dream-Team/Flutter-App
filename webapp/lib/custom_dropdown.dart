...
/**
 * RICHARD MULLENDER NOTE: TAKEN STRAIGHT FROM https://pub.dev/packages/custom_dropdown
 * Modified slightly to better fit the theme.
 */
...
class CustomDropdown extends StatefulWidget {
  ...
  final Color enabledIconColor = primaryColor;
  ...
  CustomDropdown({
    ...
    @required this.items,
    this.valueIndex,
    this.enabledColor = const Color(0xFFFFFFFF),
    ...
    this.borderRadius = _kBorderRadius,
        ...
        assert(items == null || items.length > 0, "You must specify at least one item!"),
        assert(valueIndex == null || (items != null && valueIndex >= 0 && valueIndex < items.length),
...
class CustomDropdownState extends State<CustomDropdown> {
  ...
  String get _valueText =>
      (widget.valueIndex != null && _isEnabled) ? widget.items[widget.valueIndex].text : widget.hint;
  ...
  OverlayEntry _createDropdownOverlay() {
    ...
    _dropdownPosition = (screenHeight - (yPosition + height + overlayHeight) <= 0 && yPosition - overlayHeight > 0)
    ...
    return OverlayEntry(
      builder: (context) => Positioned(
        ...
        child: CompositedTransformFollower(
          ...
          offset: Offset(0.0, (_dropdownPosition == DropdownPosition.bottom) ? 0.0 : -overlayHeight + height),
          child: DropdownData(
            items: widget.items,
    ...
    return Focus(
      ...
      child: CompositedTransformTarget(
        ...
        child: GestureDetector(
          ...
          child: Material(
            elevation: (!_isEnabled || _isOpen) ? 0.0 : 0.0,
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Text(
              valueText,
              style: TextStyle(color: dropdownData.enableTextColor, fontSize: 20, fontWeight: FontWeight.w500),
            ),
            Spacer(),
            IconTheme(
              data: IconThemeData(
  ...
  Widget _getDropdownItems(BuildContext context) {
    ...
    return ColumnBuilder(
        ...
        itemBuilder: (context, index) {
          return InkWell(
            borderRadius: (dropdownData.position == DropdownPosition.top)
                ? BorderRadius.vertical(top: (index == 0) ? Radius.circular(dropdownData.borderRadius) : Radius.zero)
    ...
    double borderRadius,
          ...
          builder: (FormFieldState<int> field) {
            ...
            return CustomDropdown(
              ...
              enabledColor: enabledColor ?? offWhite,
